...
UPDATE {usersTableName} 
    SET [Name] = @Name, [Rank] = @Rank1, [Title] = @Title1, [Skill] = @Skill1, [IPAddr1] = @IPAddr1, [Email] = @Email, [PhoneMil] = @PhoneMil, [Phone] = @Phone, [TGroups] = @TGroups, [ApplyDate] = GETDATE(), [Reason] = @Reason {(isAdmin ? ", [IPAddr2] = @IPAddr2, [Process] = @Process, [Review] = @Review, [Outcome] = @Outcome " : "")}
WHERE [UserID] = @UserID 
";
